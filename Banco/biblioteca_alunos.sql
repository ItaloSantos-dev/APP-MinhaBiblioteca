...
CREATE TABLE `alunos` (
  ...
  UNIQUE KEY `livro_pego` (`livro_pego`),
  CONSTRAINT `alunos_ibfk_1` FOREIGN KEY (`livro_pego`) REFERENCES `livros` (`id_livro`)
...
INSERT INTO `alunos` VALUES (1,'12345678910',5,NULL);
